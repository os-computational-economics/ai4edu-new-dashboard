import {
  ...
  import { setWorkspaceStatus, studentJoinWorkspace } from "@/api/workspace/workspace";
            ...
            <ModalBody>
              <div className="flex items-center gap-2 p-3 rounded-lg">
                <span className="text-black-100">
                  To confirm the action, enter the name of the workspace you'd like to archive.
                </span>
              </div>
