...
export const Chat = () => {
  ...
  return (
    <div className="flex h-[90vh]">
      ...
      <PanelGroup autoSaveId="chat-interface" direction="horizontal" className="w-full h-full">
            ...
            <div className="flex h-full">
              <div className="bg-white p-6">
                ...
                <div className="text-wrap">
                  {selectedDocument ? (
                    <>
                      <h3 className="text-xl font-bold mb-4">{selectedDocument.title}</h3>
                      <ScrollShadow className="h-[700px] w-fit rounded-md">
                        <p>
                          Lorem ipsum dolor sit amet, consecteturasdas adipiscing elit. Sed euismod tellus vel sapien
                          bibendum, vel bibendum odio consequat. Nullam volutpat metus ac nunc dapibus, id malesuada
                          velit aliquam. Suspendisse potenti. Nulla facilisi. Duis euismod, nulla sit amet aliquam
                          lacinia, nisl nisl aliquam nisl, nec aliquam nisl nisl sit amet nisl. Sed euismod tellus vel
                          sapien bibendum, vel bibendum odio consequat.Lorem ipsum dolor sit amet, consectetur
                          adipiscing elit. Sed euismod tellus vel sapien bibendum, vel bibendum odio consequat. Nullam
                          volutpat metus ac nunc dapibus, id malesuada velit aliquam. Suspendisse potenti. Nulla
                          facilisi. Duis euismod, nulla sit amet aliquam lacinia, nisl nisl aliquam nisl, nec aliquam
                          nisl nisl sit amet nisl. Sed euismod tellus vel sapien bibendum, vel bibendum odio
                          consequat.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod tellus vel
                          sapien bibendum, vel bibendum odio consequat. Nullam volutpat metus ac nunc dapibus, id
                          malesuada velit aliquam. Suspendisse potenti. Nulla facilisi. Duis euismod, nulla sit amet
                          aliquam lacinia, nisl nisl aliquam nisl, nec aliquam nisl nisl sit amet nisl. Sed euismod
                          tellus vel sapien bibendum, vel bibendum odio consequat.Lorem ipsum dolor sit amet,
                          consectetur adipiscing elit. Sed euismod tellus vel sapien bibendum, vel bibendum odio
                          consequat. Nullam volutpat metus ac nunc dapibus, id malesuada velit aliquam. Suspendisse
                          potenti. Nulla facilisi. Duis euismod, nulla sit amet aliquam lacinia, nisl nisl aliquam nisl,
                          nec aliquam nisl nisl sit amet nisl. Sed euismod tellus vel sapien bibendum, vel bibendum odio
                          consequat.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod tellus vel
                          sapien bibendum, vel bibendum odio consequat. Nullam volutpat metus ac nunc dapibus, id
                          malesuada velit aliquam. Suspendisse potenti. Nulla facilisi. Duis euismod, nulla sit amet
                          aliquam lacinia, nisl nisl aliquam nisl, nec aliquam nisl nisl sit amet nisl. Sed euismod
