...
const ChatPanel = ({ agent, thread, setSelectedDocument, newThread }) => {
  ...
  const sendMessage = async () => {
    ...
    fetch(steamChatURL, {
      ...
      .then((response) => {
        ...
        let accumulatedData = '' // Store incomplete JSON chunks
        ...
        const processStream = async () => {
          ...
          while (true) {
            ...
            accumulatedData += value // Accumulate received data
            ...
            for (const line of lines) {
              if (line.startsWith('data: ')) {
                ...
                try {
                  ...
                  accumulatedData = '' // Reset accumulatedData after successful parse
                } catch (e) {
                  if (e instanceof SyntaxError) {
                    console.warn('Incomplete JSON received, waiting for the next chunk.')
                  } else {
