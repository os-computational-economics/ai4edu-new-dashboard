  ...
  <Card isPressable onPress={() => onSelect(thread.thread_id)}>
    <CardHeader className="justify-between">
      <div className="flex flex-col gap-1">
        <h2 className="text-large font-semibold text-default-600">
          {thread.agent_name}
        </h2>
        <h5 className="text-middle tracking-tight text-default-600">
          {thread.course_id}
        </h5>
      </div>
    </CardHeader>
    <CardFooter>
      <div className="flex gap-1">
        <p className="text-small text-default-600">Created at:</p>
