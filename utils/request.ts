...
const localBackend = process.env.NEXT_PUBLIC_LOCAL_BACKEND.toUpperCase() === 'TRUE'
...
if (process.env.NODE_ENV === 'development') {
  ...
  */
  baseURL = localBackend ? process.env.NEXT_PUBLIC_LOCAL_BASE_URL : process.env.NEXT_PUBLIC_ONLINE_BASE_URL
...
instance.interceptors.request.use(
  async (config: AxiosRequestConfig) => {
    ...
    } else if (refresh_token && refresh_token !== '' && refresh_token !== 'undefined') {
